...
public interface SSLContextServerParametersFactoryBean extends AbstractJsseUtilFactoryBean, DomElement  {
                    @NotNull
        @Attribute("sessionTimeout")
        GenericAttributeValue<String> getSessionTimeout();
                    @NotNull
        @Attribute("clientAuthentication")
        GenericAttributeValue<String> getClientAuthentication();
