...
/**
 * @author Alan
 * @see me.alanfoster.camelry.blueprint.dom.model.Blueprint
 */
//@SubTag("route")
@Stubbed
public interface RouteDefinition extends ProcessorDefinition, DomElement  {
    @NotNull
    ...
    /**
     * The from element in a camel route. There should be one, or more, of these per route.
     */
/*    @SubTag(value = "from", index = 0)
    @Required
    FromDefinition getFrom();*/

    @SubTagList("from")
    List<FromDefinition> getFroms();
